...
export default function DtsFiesta() {
  return (
    <section className="min-h-[90vh] bg-pallete-6 w-full flex flex-col justify-center sombra_arriba_abajo pb-4 px-2">
      ...
      <Mono className="size-30" />
            <h2 className="text-pallete-3 text-2xl">Dress Code</h2>
            </div>
            <LineDecoration />
            <p className="text-center text-[18px] font-normal font-playfair text-pallete-1 my-5">Elegante / Formal</p>
            </ModalComponent>
...
para tener en cuenta</p>
        ...
        <div className="flex flex-col justify-center items-center gap-6 font-playfair">
          <Paper />
            <h2 className="text-pallete-2 text-2xl">Tips y Notas</h2>
