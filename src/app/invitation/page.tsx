...
export default function Page() {
  return (
    ...
    <div className=" flex flex-col items-center flex-wrap justify-center  w-full">
      ...
      <section className="min-h-[90vh] bg-pallete-6 w-full flex flex-col justify-center sombra_arriba_abajo">
       <DtsFiesta/>
      </section>
   ...
   <h2 className="text-[#655b59] font-serif text-5xl text-center mt-6">
    ...
    <div className="flex items-center justify-center mt-10"> 
     <img src="/regalo.png" alt="regalo" className="w-15 h-15 mt-2 bg-transparent animate-bounce" />
    </div>
    <div className="flex items-center justify-center mt-10">
    <Link href="/" className="text-white text-center text-[20px] mt-2 hover:bg-[#8c755e] transition-all duration-900 bg-[#b39072] rounded-[12px] h-[50px] w-[200px] flex items-center justify-center" >
            Numero de CBU
          </Link>
    </div>
   ...
   <Infinite/>
    ...
    <div className="flex items-center justify-center mt-10">
      <img src="/instagram.png" alt="instagram" className="w-15 h-15 mt-2 bg-transparent animate-bounce" />
    </div>
    ...
    <Link href="https://www.instagram.com/explore/search/keyword/?q=%2315flor" target="_blank" className="text-white text-center text-[17px] mt-2 hover:bg-[#8c755e] transition-all duration-900 bg-[#b39072] rounded-[12px] h-[50px] w-[250px] flex items-center justify-center" >
            Ver en Instagram
          </Link>
    </div>
    </section>
